...
import { ManageTransactionsContent } from './ManageTransactionsContent';

interface ManageTransactionsPageWrapperProps {
  locale: string;
  title: string;
  description: string;
}

export function ManageTransactionsPageWrapper({
  locale,
  title,
  description,
}: ManageTransactionsPageWrapperProps) {
  return (
    <StaffOnly>
      <main
