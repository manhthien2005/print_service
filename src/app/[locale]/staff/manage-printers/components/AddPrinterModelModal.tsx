...
interface AddPrinterModelModalProps {
  isOpen: boolean;
  onClose: () => void;
  brands: Brand[];
  pageSizes: string[];
  onSave: (newModel: Partial<PrinterModel>) => Promise<void>;
}

export const AddPrinterModelModal: React.FC<AddPrinterModelModalProps> = ({
  isOpen,
  onClose,
  brands,
  pageSizes,
