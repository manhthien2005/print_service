...
export default function AppDock({ locale }: AppDockProps) {
  ...
  const staffCopy = {
    en: {
      ...
      managePrintHistory: 'Print History',
      manageTransactions: 'Transaction History',
      reports: 'Reports',
    ...
    vi: {
      ...
      managePrintHistory: 'Quản lý lịch sử in',
      manageTransactions: 'Quản lý giao dịch',
      reports: 'Báo cáo',
      pageAllocation: 'Quản lý nguyên liệu in',
  ...
  const staffItems = [
    ...
    },
    {
      ...
      label: staffT.managePrintHistory,
      onClick: createNavigationHandler(`/${locale}/staff/manage-print-history`),
      path: `/${locale}/staff/manage-print-history`,
    },
    {
      icon: (
        <svg
      ...
      label: staffT.manageTransactions,
      onClick: createNavigationHandler(`/${locale}/staff/manage-transactions`),
      path: `/${locale}/staff/manage-transactions`,
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      label: staffT.pageAllocation,
      onClick: createNavigationHandler(`/${locale}/staff/page-allocation`),
      path: `/${locale}/staff/page-allocation`,
    },
    {
      icon: (
        <svg
